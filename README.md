...
This repository hosts information about running AlphaFold2 (version: 2.3.2) on [BIOMIX HPC cluster](https://bioit.dbi.udel.edu/BIOMIX/BIOMIX-cluster.html) GPU nodes using singularity.
